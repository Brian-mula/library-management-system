                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('books.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="book_number" type="text" class="form-control @error('book_number') is-invalid @enderror" name="book_number" value="{{ old('book_number') }}" required autocomplete="book_number" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="category_id" class="col-md-4 col-form-label text-md-right">{{ __('Title') }}</label>
